...
static DEVICE_ATTR(version, S_IRUGO, dmec_version_show, NULL);
static DEVICE_ATTR(fw_type, S_IRUGO, dmec_fw_type_show, NULL);
static DEVICE_ATTR(features, S_IRUGO, dmec_features_show, NULL);
